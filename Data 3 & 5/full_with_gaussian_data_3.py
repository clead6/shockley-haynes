...
popt_dif, pcov_dif = curve_fit(proportional, t_0**3, (fwhm*d)**2)
...
x_data = np.linspace(0, 1.8e-14, 1000)
y_unc = 2*fwhm*unc_fwhm
plt.plot(x_data, proportional(x_data, popt_dif[0]))
plt.scatter(t_0**3, (fwhm*d)**2, marker=".")
#plt.errorbar(t_0**3, (fwhm*d)**2, yerr=y_unc, ls="none")
