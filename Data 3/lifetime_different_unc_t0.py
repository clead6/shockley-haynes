...
print(unc_n_0 *100 / n_0)
print(unc_t_0 *100 / (2*t_0))
...
tau = -1/fit[0][0]
unc_fit = np.sqrt(np.diag(fit[1]))
unc_tau = abs(tau * unc_fit[0] / fit[0][0])

print("lifetime=", tau*10**6, "+/-", unc_tau*10**6, ", ", unc_tau/tau *100, "%")
print(red_chi2_linear)
