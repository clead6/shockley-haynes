...
for key in keys:
    ...
    if 17<=counter<=22:
        ...
        time = data[key][900:2400,3]
        volt = data[key][900:2400,4] 
    ...
    if 22<counter<31:
        time = data[key][600:2400,3]
        volt = data[key][600:2400,4]
    ...
    if 30<counter<39:
        time = data[key][500:2300,3]
        volt = data[key][500:2300,4]
