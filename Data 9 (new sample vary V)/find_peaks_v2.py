...
for key in keys:
    ...
    if 17<=counter<=23:
        time = data[key][800:1900,3]
        volt = data[key][800:1900,4] 
    ...
    if 23<counter:
        time = data[key][850:1700,3]
        volt = data[key][850:1700,4]
    ...
    peaks, properties = find_peaks(volt_subt, distance=1500, width=100, height = -8)     
