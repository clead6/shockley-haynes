...
for key in keys:
    ...
    if 23<counter<=40:
        time = data[key][850:1600,3]
        volt = data[key][850:1600,4]
    ...
    if 40<counter:
        time = data[key][850:1500,3]
        volt = data[key][850:1500,4]
...
x_data = np.linspace(0, 1.5e-14, 1000)
...
x_data = np.linspace(1.6e-5,2.5e-5,1000)
