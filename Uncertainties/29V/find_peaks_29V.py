...
files = ["set1.CSV","set2.CSV","set3.CSV","set4.CSV","set5.CSV","set6.CSV"]
keys = ["set1","set2","set3","set4","set5","set6"]
voltage = np.array([29,29,29,29,29,29])
...
for key in keys:
    ...
    time = data[key][200:2450,3]
    volt = data[key][200:2450,4]
    ...
    plt.xlabel("time")
    plt.ylabel("voltage")
    plt.title("29V Set {0}".format(counter))
    plt.savefig("gaussian_29V_set{0}_fp".format(counter),dpi=300)
    plt.show()
